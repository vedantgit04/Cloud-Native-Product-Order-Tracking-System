...
import com.UserService.Security.Repo.AuthorizationRepo;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    private final AuthorizationRepo authorizationRepository;
    private final RegisteredClientRepository registeredClientRepository;
    private final ObjectMapper objectMapper = new ObjectMapper();

    public JpaOAuth2AuthorizationService(AuthorizationRepo authorizationRepository, RegisteredClientRepository registeredClientRepository) {
